...
(function (window, document) {
	...
	Croppic.prototype = {
		...
		createImgUploadControls: function(){
			...
			console.log("End createImgUploadControls");
			
		},
		bindImgUploadControl: function(){
			console.log("Bind ImgUploadControl");
...
//test					
				...
				console.log("imgUploadControl hide");	
...
//test					
			...
			//test					
					console.log("FileReader");	
					 ...
					 //not process inline				    					
					console.log("Not process inline");	
					try {
						// other modern browsers
						formData = new FormData(that.form[0]);
						console.log("formData creation1");	

					} catch(e) {
						console.log("formData creation2");	
						// IE10 MUST have all form items appended as individual form key / value pairs
						formData = new FormData();
						formData.append('img', that.form.find("input[type=file]")[0].files[0]);
					}
						
					console.log("Key appends");	
					for (var key in that.options.uploadData) {
						if( that.options.uploadData.hasOwnProperty(key) ) {
							formData.append( key , that.options.uploadData[key] );	
							console.log("Has "+ key+":"+that.options.uploadData[key]);
						}else{
							console.log("Not has "+ key+":"+that.options.uploadData[key]);
						}
						console.log(key+":"+that.options.uploadData[key]);
					}										
...
//test
						...
						console.log("url="+that.options.uploadUrl);	
						console.log("data=");	
						console.log(data);	
//end-test
			 ...
			 console.log("End Bind ImgUploadControl");
        },
		loadExistingImage: function(){
			...
			if( $.isEmptyObject(that.croppedImg)){
			 ...
			 console.log("End loadExistingImage");
		},
		...
		createModal: function(){
			...
			that.obj = $('#croppicModalObj');
				...
				console.log("END createModal :");
		},
		destroyModal: function(){
				console.log("DtroyModal");
			var that = this;
			
			that.obj = that.outputDiv;
			that.modal.remove();
			that.modal = {};
			console.log("End DestroyModal");
		},
		initCropper: function(){
			...
			console.log("END initCropper");
		},
		createEyecandy: function(){
			console.log("create Eyecandy");
			var that = this;

			that.imgEyecandy = that.img.clone();
			that.imgEyecandy.css({'z-index':'0','opacity':that.options.imgEyecandyOpacity}).appendTo(that.obj);
			console.log("end create Eyecandy");
		},
		destroyEyecandy: function(){
			console.log("destroy Eyecandy");
			var that = this;
			that.imgEyecandy.remove();
			console.log("end destroy Eyecandy");
		},
		initialScaleImg:function(){
			...
			console.log("END initialScaleImg");
		},
		
		createCropControls: function(){
			console.log("creteCropControls");
			var that = this;
			...
			console.log("END creteCropControls");
		},
		initDrag:function(){
		...
		isAjaxUploadSupported: function () {
		   ...
		   console.log("isAjaxUploadSupported");
            ...
            input.type = "file";
		      console.log("END isAjaxUploadSupported");
		   ...
		   console.log("CreateFallbackIframe");
            ...
            if (!that.isAjaxUploadSupported()) { 
                ...
                var eventHandlermyFile = function () {
		   		...
		   		console.log("END CreateFallbackIframe");
