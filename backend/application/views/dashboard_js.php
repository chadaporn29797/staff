...
$('#addEducationModal .btn-success').on("click",function(e){
	...
	$.post('<?= site_url('main/ajax_addDetail') ?>',{ 'userID' : <?= $userID ?> , 'detail' : content, 'tableName' : 'education' },function(data){
		if( data.success == true){
...
$('.delete-education').click(function(e){
	...
	var target = $(this);
	var id = $(this).data("id") ;
	$.post('<?= site_url('main/ajax_deleteDetail') ?>',{ 'id' : id, 'tableName' : 'education' },function(data){
		if( data.success == true){
			alert("ลบสำเร็จ");
...
$('.sort-education').on("click",function(e){
	...
	$.post('<?= site_url('main/ajax_sortDetail') ?>',{ 'tableName' : 'education' , 'userID': <?= $userID ?> ,'id' : id, 'sortOrder' : sortOrder , 'direction' : direction },function(data){
		if( data.success == true){
			location.reload(true);
		}
	},"json");
...
$('#editEducationModal .btn-success').on("click",function(e){
	...
	$.post('<?= site_url('main/ajax_updateDetail') ?>',{ 'tableName': 'education' ,'id' : id, 'detail' : content },function(data){
		if( data.success == true){
			alert("บันทึกสำเร็จ");
			location.reload(true);
		}
...
$('#addAwardModal .btn-success').on("click",function(e){
	...
	$.post('<?= site_url('main/ajax_addDetail') ?>',{ 'userID' : <?= $userID ?> , 'detail' : content, 'tableName' : 'award' },function(data){
		if( data.success == true){
			location.reload(true);
		}
	},"json");
...
$('.delete-award').click(function(e){
	...
	var target = $(this);
	var id = $(this).data("id") ;
	$.post('<?= site_url('main/ajax_deleteDetail') ?>',{ 'id' : id, 'tableName' : 'award' },function(data){
		if( data.success == true){
			alert("ลบสำเร็จ");
			$(target).closest('div .row').remove();
		}
...
$('.sort-award').on("click",function(e){
	...
	$.post('<?= site_url('main/ajax_sortDetail') ?>',{ 'tableName' : 'award' , 'userID': <?= $userID ?> ,'id' : id, 'sortOrder' : sortOrder , 'direction' : direction },function(data){
		if( data.success == true){
			location.reload(true);
		}
	},"json");
...
$('#editAwardModal .btn-success').on("click",function(e){
	...
	console.log( content + ": " + id );
	$.post('<?= site_url('main/ajax_updateDetail') ?>',{ 'tableName': 'award' ,'id' : id, 'detail' : content },function(data){
		if( data.success == true){
			alert("บันทึกสำเร็จ");
			location.reload(true);
		}
...
$('#addScholarshipModal .btn-success').on("click",function(e){
	...
	$.post('<?= site_url('main/ajax_addDetail') ?>',{ 'userID' : <?= $userID ?> , 'detail' : content, 'tableName' : 'scholarship' },function(data){
		if( data.success == true){
			location.reload(true);
		}
	},"json");
...
$('.delete-scholarship').click(function(e){
	...
	var target = $(this);
	var id = $(this).data("id") ;
	$.post('<?= site_url('main/ajax_deleteDetail') ?>',{ 'id' : id, 'tableName' : 'scholarship' },function(data){
		if( data.success == true){
			alert("ลบสำเร็จ");
			$(target).closest('div .row').remove();
		}
...
$('.sort-scholarship').on("click",function(e){
	...
	$.post('<?= site_url('main/ajax_sortDetail') ?>',{ 'tableName' : 'scholarship' , 'userID': <?= $userID ?> ,'id' : id, 'sortOrder' : sortOrder , 'direction' : direction },function(data){
		if( data.success == true){
			location.reload(true);
		}
	},"json");
...
$('#editScholarshipModal .btn-success').on("click",function(e){
	...
	console.log( content + ": " + id );
	$.post('<?= site_url('main/ajax_updateDetail') ?>',{ 'tableName': 'scholarship' ,'id' : id, 'detail' : content },function(data){
		if( data.success == true){
			alert("บันทึกสำเร็จ");
			location.reload(true);
		}
...
$('#addWork_expModal .btn-success').on("click",function(e){
	...
	$.post('<?= site_url('main/ajax_addDetail') ?>',{ 'userID' : <?= $userID ?> , 'detail' : content, 'tableName' : 'work_exp' },function(data){
		if( data.success == true){
			location.reload(true);
		}
	},"json");
...
$('.delete-work_exp').click(function(e){
	...
	var target = $(this);
	var id = $(this).data("id") ;
	$.post('<?= site_url('main/ajax_deleteDetail') ?>',{ 'id' : id, 'tableName' : 'work_exp' },function(data){
		if( data.success == true){
			alert("ลบสำเร็จ");
			$(target).closest('div .row').remove();
		}
...
$('.sort-work_exp').on("click",function(e){
	...
	$.post('<?= site_url('main/ajax_sortDetail') ?>',{ 'tableName' : 'work_exp' , 'userID': <?= $userID ?> ,'id' : id, 'sortOrder' : sortOrder , 'direction' : direction },function(data){
		if( data.success == true){
			location.reload(true);
		}
	},"json");
...
$('#editWork_expModal .btn-success').on("click",function(e){
	...
	console.log( content + ": " + id );
	$.post('<?= site_url('main/ajax_updateDetail') ?>',{ 'tableName': 'work_exp' ,'id' : id, 'detail' : content },function(data){
		if( data.success == true){
			alert("บันทึกสำเร็จ");
			location.reload(true);
		}
...
$('#addPublicationModal .btn-success').on("click",function(e){
	...
	$.post('<?= site_url('main/ajax_addDetail') ?>',{ 'userID' : <?= $userID ?> , 'detail' : content, 'tableName' : 'publication' },function(data){
		if( data.success == true){
			location.reload(true);
		}
	},"json");
...
$('.delete-publication').click(function(e){
	...
	var target = $(this);
	var id = $(this).data("id") ;
	$.post('<?= site_url('main/ajax_deleteDetail') ?>',{ 'id' : id, 'tableName' : 'publication' },function(data){
		if( data.success == true){
			alert("ลบสำเร็จ");
			$(target).closest('div .row').remove();
		}
...
$('.sort-publication').on("click",function(e){
	...
	$.post('<?= site_url('main/ajax_sortDetail') ?>',{ 'tableName' : 'publication' , 'userID': <?= $userID ?> ,'id' : id, 'sortOrder' : sortOrder , 'direction' : direction },function(data){
		if( data.success == true){
			location.reload(true);
		}
	},"json");
...
$('#editPublicationModal .btn-success').on("click",function(e){
	...
	console.log( content + ": " + id );
	$.post('<?= site_url('main/ajax_updateDetail') ?>',{ 'tableName': 'publication' ,'id' : id, 'detail' : content },function(data){
		if( data.success == true){
			alert("บันทึกสำเร็จ");
			location.reload(true);
		}
...
$('#addSkillModal .btn-success').on("click",function(e){
	...
	$.post('<?= site_url('main/ajax_addDetail') ?>',{ 'userID' : <?= $userID ?> , 'detail' : content, 'tableName' : 'skill' },function(data){
		if( data.success == true){
			location.reload(true);
		}
	},"json");
...
$('.delete-skill').click(function(e){
	...
	var target = $(this);
	var id = $(this).data("id") ;
	$.post('<?= site_url('main/ajax_deleteDetail') ?>',{ 'id' : id, 'tableName' : 'skill' },function(data){
		if( data.success == true){
			alert("ลบสำเร็จ");
			$(target).closest('div .row').remove();
		}
...
$('.sort-skill').on("click",function(e){
	...
	$.post('<?= site_url('main/ajax_sortDetail') ?>',{ 'tableName' : 'skill' , 'userID': <?= $userID ?> ,'id' : id, 'sortOrder' : sortOrder , 'direction' : direction },function(data){
		if( data.success == true){
			location.reload(true);
		}
	},"json");
...
$('#editSkillModal .btn-success').on("click",function(e){
	...
	console.log( content + ": " + id );
	$.post('<?= site_url('main/ajax_updateDetail') ?>',{ 'tableName': 'skill' ,'id' : id, 'detail' : content },function(data){
		if( data.success == true){
			alert("บันทึกสำเร็จ");
			location.reload(true);
		}
...
$('#addTrainingModal .btn-success').on("click",function(e){
	...
	$.post('<?= site_url('main/ajax_addDetail') ?>',{ 'userID' : <?= $userID ?> , 'detail' : content, 'tableName' : 'training' },function(data){
		if( data.success == true){
			location.reload(true);
		}
	},"json");
...
$('.delete-training').click(function(e){
	...
	var target = $(this);
	var id = $(this).data("id") ;
	$.post('<?= site_url('main/ajax_deleteDetail') ?>',{ 'id' : id, 'tableName' : 'training' },function(data){
		if( data.success == true){
			alert("ลบสำเร็จ");
			$(target).closest('div .row').remove();
		}
...
$('.sort-training').on("click",function(e){
	...
	$.post('<?= site_url('main/ajax_sortDetail') ?>',{ 'tableName' : 'training' , 'userID': <?= $userID ?> ,'id' : id, 'sortOrder' : sortOrder , 'direction' : direction },function(data){
		if( data.success == true){
			location.reload(true);
		}
	},"json");
...
$('#editTrainingModal .btn-success').on("click",function(e){
	...
	console.log( content + ": " + id );
	$.post('<?= site_url('main/ajax_updateDetail') ?>',{ 'tableName': 'training' ,'id' : id, 'detail' : content },function(data){
		if( data.success == true){
			alert("บันทึกสำเร็จ");
			location.reload(true);
		}
...
$('#editOverviewModal button.btn-success').on("click",function(e){
	...
	$.post('<?= site_url('main/ajax_updateOverview') ?>',{ 'userID' : <?= $userID ?>, 'description' : content },function(data){
		if( data.success == true){
			alert("บันทึกสำเร็จ");
