  ...
  <div class="content-wrapper">
    ...
    <div class="content-header row">
      <div class="content-header-left col-md-4 col-12 mb-2">
        <h3 class="content-header-title">แก้ไขข้อมูลพื้นฐาน</h3>
      </div>
        ...
        <div class="breadcrumbs-top float-md-right">
          <div class="breadcrumb-wrapper mr-1">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">แก้ไขข้อมูลพื้นฐาน
              </li>
            </ol>
          </div>
        </div>
                ...
                <form method="POST" action="<?= site_url('main/save_profile') ?>" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-2">
                      ...
                      <div class=" ml-1 ">
                        <input type="text" id="forName" name="forName" required="required" class="form-control " value="<?= $info->forName ?>">
                      </div>
                    </div>
