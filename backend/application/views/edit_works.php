                  ...
                  <div class="x_content">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?= $w->detail ?></td>
                          <td>
								  <a href='<?= site_url('main/edit_works/'.$w->id) ?>'>
								  <i class="fa fa-wrench"></i> 
								  </a>
								  <a href='<?= site_url('main/remove_work/'.$w->id) ?>'>
