              ...
              <?php else : ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="wYear" name="wYear" required="required" class="form-control col-md-7 col-xs-12" value="<?= isset($winfo) ? $winfo->wYear : ""  ?>">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="wName" name="wName" required="required" class="form-control col-md-7 col-xs-12" value="<?= isset($winfo) ? $winfo->wName : ""  ?>">
                  </div>
                </div>
                <div class="form-group">
